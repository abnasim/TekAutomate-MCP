...
/**
 * Returns the most recently pushed workflow across ALL sessions.
 * Used as a fallback when the chatkit session key doesn't match the
 * live session key the browser pushed under — both are valid but different keys.
 */
