...
function buildLiveSystemPrompt(req: McpChatRequest, sessionContext?: string): string {
  const parts = [
    ...
    '',
    '### Knowledge (use these for questions, errors, docs)',
    '- **retrieve_rag_chunks** — Search the knowledge base. Corpora: errors, app_logic, pyvisa_tekhsi, tmdevices. Use for "why is X happening?" or "how does Y work?"',
    '- **search_known_failures** — Troubleshoot errors. Use when a command fails and you need to know why.',
    '',
