...
import tek_style.widgetstyle as wgs
import tek_style.windowstyle as wds


class Style:
    """Tektronix dark theme for QtModernRedux6."""
    ...
    def get_window_stylesheet() -> str:
        ...
        qss = qss.replace('{BUTTON_DIAMETER_HALF_PX}',
                           str(wds.Constants.TITLE_BAR_BUTTON_DIAMETER_PX / 2))
        return qss
    ...
    def apply_theme(app: QApplication) -> None:
        style = ''.join([
            wgs.base_style, wgs.combobox_style, wgs.groupbox_style,
            wgs.headerview_style, wgs.lineedit_style, wgs.progressbar_style,
            wgs.qpushbutton_style, wgs.scrollarea_style, wgs.scrollbar_style,
            wgs.slider_style, wgs.spinbox_style, wgs.splitter_style,
            wgs.tableview_style, wgs.tabwidget_style, wgs.toolbar_style,
