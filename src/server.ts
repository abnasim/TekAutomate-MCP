      ...
      return {
        resources: [
          ...
          },
          {
            ...
            description: 'Most recent workflow proposal staged by the AI agent via workflow_ui{stage}. Append session key via the proposals/session/{key} template.',
            mimeType: 'application/json',
          },
          {
            uri: `${base}/tools/list`,
            name: 'Router Tool Catalog',
            description: 'Full list of router-hydrated tools. Use tek_router for semantic search instead of enumerating.',
            mimeType: 'application/json',
          },
        ],
      };
        ...
        resourceTemplates: [
          {
            ...
            description: 'Staged workflow proposal for a specific ChatKit session. {sessionKey} is returned by workflow_ui{current}.sessionKey.',
            mimeType: 'application/json',
          },
          {
